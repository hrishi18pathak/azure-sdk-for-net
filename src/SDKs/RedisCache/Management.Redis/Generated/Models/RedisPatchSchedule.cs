...
namespace Microsoft.Azure.Management.Redis.Models
{
    ...
    public partial class RedisPatchSchedule
    {
        ...
        public RedisPatchSchedule(IList<ScheduleEntry> scheduleEntriesProperty, string id = default(string), string name = default(string), string type = default(string), string location = default(string))
        {
            Id = id;
            Name = name;
            Type = type;
        ...
        public IList<ScheduleEntry> ScheduleEntriesProperty { get; set; }
